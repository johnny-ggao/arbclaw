...
import type { SymbolStats } from "@/app/lib/api";

export default function SymbolChart({ data }: { data: SymbolStats[] }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <BarChart data={sorted} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
        ...
        <XAxis dataKey="symbol" tick={{ fill: "#a0a0a0", fontSize: 11 }} tickLine={false} axisLine={false} />
